...
import 'package:platform_design/screens/songs_tab.dart';
import 'screens/news_tab.dart';
import 'package:platform_design/screens/profile_tab.dart';
import 'package:platform_design/screens/settings_tab.dart';
  ...
  MultiBlocProvider(
    providers: [
      ...
      BlocProvider<SongBloc>(
        create: (context) => SongBloc()..add(AppStarted()),
      ),
    ],
    child: MyAdaptingApp(),
  )
      ...
      tabBar: CupertinoTabBar(
        items: [
          BottomNavigationBarItem(
              label: SongsTab.title, icon: SongsTab.iosIcon),
          BottomNavigationBarItem(
              label: NewsTab.title, icon: NewsTab.iosIcon),
          BottomNavigationBarItem(
              label: ProfileTab.title, icon: ProfileTab.iosIcon),
        ],
      ),
